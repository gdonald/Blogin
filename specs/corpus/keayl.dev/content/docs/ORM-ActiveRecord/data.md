...
slug: data
order: 27
description: ORM::ActiveRecord supports many forms of data validations, when they occur and if they occur at all.
toc: true
---
...
options (see [Conditionals](/docs/ORM-ActiveRecord/conditionals)). The guard is evaluated once for
...
options (see [Conditionals](/docs/ORM-ActiveRecord/conditionals)). With `strict => True`, an
