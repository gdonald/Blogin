...
slug: adapters
order: 3
description: ORM::ActiveRecord supports three database backends: PostgreSQL, MySQL, and SQLite. Tests run against all three on every CI build. Application code is the...
toc: true
---
...
[Tests](/docs/ORM-ActiveRecord/tests).
