...
slug: persistence
order: 23
description: ORM::ActiveRecord exposes both quiet (return False on failure) and loud (raise an exception on failure) variants of the persistence methods. Use whichever...
toc: true
---
...
See [Migrations &raquo; Timestamps](/docs/ORM-ActiveRecord/migrations#timestamps) for the
column setup.
