...
slug: raw
order: 21
description: When the chainable relation DSL is not enough, ORM::ActiveRecord exposes a handful of escape hatches that let you reach for raw SQL or Common Table...
toc: true
---
...
See [Inspection helpers](/docs/ORM-ActiveRecord/inspection#to-sql).
