...
slug: queries
order: 16
description: This page covers the filtering and relation-modification vocabulary that builds on the basics in Relations. Everything here returns a new relation — the...
toc: true
---
This page covers the filtering and relation-modification vocabulary that
builds on the basics in [Relations](/docs/ORM-ActiveRecord/relations). Everything here returns
...
For [`:json` / `:jsonb` columns](/docs/ORM-ActiveRecord/migrations#column-types), pass a
