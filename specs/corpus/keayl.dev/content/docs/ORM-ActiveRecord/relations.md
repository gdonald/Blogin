...
slug: relations
order: 15
description: User.where(...), User.order(...), and friends return a chainable relation that defers running SQL until you ask for results. Relations compose: every...
toc: true
---
...
See [Queries](/docs/ORM-ActiveRecord/queries) for the full filtering vocabulary, including
...
`distinct`; see [Aggregation](/docs/ORM-ActiveRecord/aggregation).
