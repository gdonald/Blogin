...
slug: i18n
order: 14
description: MVC::Keayl::I18n is a translation and localization backend. It loads locale files into one store, looks up translations by dotted key, interpolates and...
toc: true
---
...
Each of these takes the model as a class or an instance, so the form helpers can
pass the record they are building through unchanged.
