...
slug: tags
order: 22
description: Tags are metadata you attach to examples or groups so the runner can include or exclude subsets of your spec suite at run time. They are useful for...
toc: true
---
