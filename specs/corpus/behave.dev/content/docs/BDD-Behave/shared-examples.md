...
order: 11
description: Shared examples let you package up a set of it blocks under a name and reuse them across any number of describe or context groups. They're useful when...
toc: true
---
...
Shared examples are a complement to [Shared Contexts](/docs/BDD-Behave/shared-contexts): a shared *context* contributes setup (lets and hooks), while shared *examples* contribute the assertions themselves.
