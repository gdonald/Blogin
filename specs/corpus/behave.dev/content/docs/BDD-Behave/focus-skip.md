---
title: Focus and Skip
slug: focus-skip
order: 23
description: Behave provides DSL helpers for skipping examples that should not run and for focusing on a subset of examples while iterating on a feature. They behave...
toc: true
---
