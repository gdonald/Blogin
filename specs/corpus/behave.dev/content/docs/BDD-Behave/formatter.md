...
slug: formatter
order: 30
description: Behave's runner is decoupled from its output: every line it prints is emitted through a formatter. The default selection (when --format is not given) is...
toc: true
---
