...
slug: describe
order: 4
description: describe and context define a group of related examples. They are aliases: pick whichever reads better in plain English. Groups can be nested arbitrarily.
toc: true
---
