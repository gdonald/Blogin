...
slug: timing
order: 33
description: Behave records how long each example takes to run. Timing data lives on the Example node itself, so any consumer that walks the spec tree after a run...
toc: true
---
