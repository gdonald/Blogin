---
title: Dry Run and Listing
slug: dry-run
order: 27
description: Behave can load spec files and report what *would* run without actually executing any example. Two CLI flags surface this from different angles:
toc: true
---
