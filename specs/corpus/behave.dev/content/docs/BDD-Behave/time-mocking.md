...
slug: time-mocking
order: 21
description: BDD::Behave ships with Timecop-style helpers for freezing and traveling through time inside an example. They work by wrapping Raku's now term,...
toc: true
---
