---
title: Composable Matchers
slug: composable-matchers
order: 17
description: Combine matchers with .and and .or to express compound expectations without writing a one-off custom matcher. Every type that does the Matcher role gets...
toc: true
---
...
[Matcher](/docs/BDD-Behave/matchers) role gets these two methods automatically, so they
work with built-in matchers, hand-rolled `does Matcher` classes, and
[`define-matcher`](/docs/BDD-Behave/custom-matchers) factories alike.
