...
slug: pending
order: 6
description: pending marks an example as not yet implemented and records a human-readable reason. The example is registered, counted, and reported under the PENDING...
toc: true
---
