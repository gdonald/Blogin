...
slug: coverage
order: 32
description: Behave can track which lines of your application code execute during a spec run and report what percentage was covered. Pass --coverage to bin/behave, and...
toc: true
---
...
[Coverage under --parallel](/docs/BDD-Behave/parallel#coverage) in the parallel
