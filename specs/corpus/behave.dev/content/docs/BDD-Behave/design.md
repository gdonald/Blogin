---
title: Parallel Execution: Design
slug: design
order: 36
description: This document describes how --parallel N works internally. For the user-facing guide, see Parallel Execution.
toc: true
---
This document describes how `--parallel N` works internally. For the user-facing
guide, see [Parallel Execution](/docs/BDD-Behave/parallel).
